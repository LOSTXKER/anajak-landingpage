    ...
    sections: [
      ...
      },
      {
        ...
        slots: [
          ...
          { slot: 'portfolio-17', label: 'ผลงานเสื้อวงดนตรี', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อวงดนตรี/คอนเสิร์ต สกรีนลายอาร์ตเวิร์ค ถ่าย flat lay หรือมีคนสวม สไตล์ร็อค' },
          { slot: 'portfolio-18', label: 'ผลงานเสื้อคาเฟ่', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อพนักงานคาเฟ่ มีโลโก้ร้าน ถ่ายบรรยากาศร้านกาแฟ สไตล์มินิมอล' },
          { slot: 'portfolio-19', label: 'ผลงานเสื้อมหาวิทยาลัย', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อรับน้อง/เสื้อคณะ สีสดใส ถ่ายกลุ่มนักศึกษาสวมเสื้อ' },
          { slot: 'portfolio-20', label: 'ผลงานเสื้อร้านอาหาร', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อยูนิฟอร์มร้านอาหาร มีโลโก้ ถ่ายพนักงานสวมในบรรยากาศร้าน' },
          { slot: 'portfolio-21', label: 'ผลงานเสื้อแคมป์', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อค่ายอาสา/แคมป์ สกรีนลาย ถ่ายกลุ่มคนสวมในกิจกรรมกลางแจ้ง' },
          { slot: 'portfolio-22', label: 'ผลงานเสื้อฟิตเนส', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อยิม/ฟิตเนส Dryfit สกรีนโลโก้ ถ่ายสไตล์สปอร์ต แอ็คทีฟ' },
          { slot: 'portfolio-23', label: 'ผลงานเสื้อชมรม', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อชมรม/สโมสร มีโลโก้และชื่อ ถ่ายกลุ่มสมาชิกสวมเสื้อ' },
          { slot: 'portfolio-24', label: 'ผลงานเสื้อเทศกาล', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อสงกรานต์/ลอยกระทง/เทศกาล ลายสีสัน ถ่ายบรรยากาศเทศกาล' },
          { slot: 'portfolio-25', label: 'ผลงานเสื้อ Streetwear', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อ Streetwear ลายกราฟิกเท่ๆ ถ่ายสไตล์แฟชั่นถนน urban' },
          { slot: 'portfolio-26', label: 'ผลงานเสื้อทีมฟุตบอล', recommendedSize: '800x600', aspectRatio: '4:3', photographyBrief: 'เสื้อฟุตบอลสกรีนเบอร์และชื่อ ถ่ายสไตล์กีฬา มีสนามเป็นแบ็คกราวด์' },
        ],
      },
    ],
  },
