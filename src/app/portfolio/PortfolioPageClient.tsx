...
export default function PortfolioPageClient({ images }: { images: Record<string, ImagesBySection> }) {
  const img = (slot: string, fallback: string) => images['portfolio-cases']?.[slot]?.url || fallback;
