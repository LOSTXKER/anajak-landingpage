...
export default function CalculatorPageClient({ images }: { images: Record<string, ImagesBySection> }) {
  const calcImg = (slot: string, fallback: string) => images['calculator']?.[slot]?.url || fallback;
