...
export default function FabricPageClient({ images }: { images: Record<string, ImagesBySection> }) {
  const img = (slot: string, fallback: string) => images['fabric-page']?.[slot]?.url || fallback;
