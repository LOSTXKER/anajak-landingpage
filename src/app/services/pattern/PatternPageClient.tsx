...
export default function PatternPageClient({ images }: { images: Record<string, ImagesBySection> }) {
  const img = (slot: string, fallback: string) => images['pattern-page']?.[slot]?.url || fallback;
