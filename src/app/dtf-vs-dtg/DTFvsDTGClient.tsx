...
export default function DTFvsDTGClient({ images }: { images: Record<string, ImagesBySection> }) {
  const img = (section: string, slot: string, fallback: string) => images[section]?.[slot]?.url || fallback;
      ...
      <section className="py-20 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            {/* DTF Image */}
            <ImageSlotOverlay sectionId="compare-dtf-vs-dtg" slotId="compare-dtf">
            <div className="card overflow-hidden">
              <div className="aspect-square bg-gradient-to-br from-ci-blue/10 to-ci-blue/5 relative">
                <CompareImage src={img('compare-dtf-vs-dtg', 'compare-dtf', '')} alt="ตัวอย่างงาน DTF" />
                {!img('compare-dtf-vs-dtg', 'compare-dtf', '') && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center p-8">
                      <Sparkles className="w-16 h-16 text-ci-blue mx-auto mb-4" />
                      <p className="text-slate-500">ภาพงาน DTF จริง</p>
                      <p className="text-sm text-slate-400 mt-2">อัปโหลดจากหลังบ้าน</p>
                    </div>
                  </div>
                )}
              </div>
            ...
            {/* DTG Image */}
            <ImageSlotOverlay sectionId="compare-dtf-vs-dtg" slotId="compare-dtg">
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl overflow-hidden md:hover:shadow-2xl md:hover:-translate-y-1 transition-all duration-300">
              <div className="aspect-square bg-gradient-to-br from-slate-700 to-slate-800 relative">
                <CompareImage src={img('compare-dtf-vs-dtg', 'compare-dtg', '')} alt="ตัวอย่างงาน DTG" />
                {!img('compare-dtf-vs-dtg', 'compare-dtg', '') && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center p-8">
            ...
            {/* Silk Screen Image */}
            <ImageSlotOverlay sectionId="compare-dtf-vs-dtg" slotId="compare-silk">
            <div className="bg-slate-700 rounded-2xl overflow-hidden md:hover:shadow-2xl md:hover:-translate-y-1 transition-all duration-300">
              <div className="aspect-square bg-slate-600 relative">
                <CompareImage src={img('compare-dtf-vs-dtg', 'compare-silk', '')} alt="ตัวอย่างงาน Silk Screen" />
                {!img('compare-dtf-vs-dtg', 'compare-silk', '') && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center p-8">
