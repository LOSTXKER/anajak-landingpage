...
export default function AboutPageClient({ images }: { images: Record<string, ImagesBySection> }) {
  const img = (slot: string, fallback: string) => images['about']?.[slot]?.url || fallback;
