...
export default function Header({ navMode = 'auto' }: HeaderProps) {
  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-[9999]" style={{ top: '72px' }}>
          {/* Backdrop */}
          <div 
          ...
          {/* Menu Panel */}
          <div className="absolute top-0 right-0 bottom-0 w-[85%] max-w-sm bg-white shadow-2xl overflow-y-auto">
            <div className="p-6 space-y-2">
              {/* Contact Info */}
              <div className="pb-4 mb-4 border-b border-slate-200 space-y-3">
                <a 
                  href={siteConfig.phoneHref} 
                  className="flex items-center gap-3 text-slate-600 hover:text-ci-blue transition-colors"
                >
