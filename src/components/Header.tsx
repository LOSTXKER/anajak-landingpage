  ...
  return (
    ...
    >
                  ...
                  >
                    ...
                    {openDropdown === item.name && (
                        <div className="absolute top-full left-0 -mt-1 pt-3 w-56">
                          <div className="bg-white rounded-xl shadow-xl border border-slate-200 py-2 animate-fade-in-down">
                              ...
                              >
                                ...
                                {openNestedDropdown === child.name && (
                                  <div className="absolute left-full top-0 ml-1 w-56">
                                    <div className="bg-white rounded-xl shadow-xl border border-slate-200 py-2 animate-fade-in-left">
      ...
      {/* Mobile Menu - Outside header for proper z-index */}
        <div 
        className={`lg:hidden fixed inset-x-0 bg-white shadow-2xl border-t border-slate-200 z-[56] overflow-y-auto ${
